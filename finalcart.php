...
$bought = $rows['copies'];
$bb = $rows['bookid'];
$qryleft = "update allgenre set availability = 'availability-'$bought'' where bookid= '$bb'";
?>
<td><?php echo $rows['totalprice']; ?></td>

<?php $sm += $rows['totalprice']; ?>
</tr>
<?php
}
?>
...
<br><br><br>
<div class = "totpriceprint">

<?php 
echo "TOTAL PRICE: " .$sm;
?>
</div>
<!-- $tptp = "select sum(totalprice) from trialcart where username = (select username
from login
where id=(select max(id) from login))";
echo "TOTAL PRICE : " .$tptp;
?> -->

<br><br>
<!-- input type = "submit" onclick="location.href='cartpg.html'"value="DELETE" name="del" -->
<center>
<button class="buttonlogout" onclick="myFunction()">PRINT</button>
...
<br><br><br><br>
<!-- a href="delete&checkout.php"><button class="button">CHECKOUT</button></a -->
